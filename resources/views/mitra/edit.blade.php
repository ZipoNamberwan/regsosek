                ...
                <div class="col-lg-6 col-7">
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Ubah Petugas Pengolahan</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-3">Ubah Petugas Pengolahan</h3>
                    </div>
                    <!-- Card body -->
                    <div class="card-body">
                        <form id="formupdate" autocomplete="off" method="post" action="/mitra/{{$user->id}}" class="needs-validation" enctype="multipart/form-data" novalidate>
                            @csrf
                            @method('put')
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select id="shift" name="shift" class="form-control" data-toggle="select" name="shift" required>
                                        ...
                                        <option value="{{ $shift->id }}" {{ old('shift', $user->status_shift_id) == $shift->id ? 'selected' : '' }}>
                                            {{ $shift->name }}
                                        </option>
                                        @endforeach
                                    </select>
