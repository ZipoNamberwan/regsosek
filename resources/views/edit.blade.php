            ...
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-3">Ubah Rekap Entri K</h3>
                        <h4>[{{$entry->slsdetail->fullcode()}}] {{$entry->slsdetail->fullname()}}</h4>
                        <!-- <p>Tanggal Mulai Entri: {{$entry->begin}}</p> -->
                    </div>
                    <!-- Card body -->
                    <div class="card-body">
                        <form id="formupdate" autocomplete="off" method="post" action="/entry/{{$entry->id}}/edit" class="needs-validation" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <div>
                                        <label class="form-control-label" for="exampleDatepicker">Tanggal Mulai Entri <span class="text-danger">*</span></label>
                                        <input name="begin" class="form-control @error('begin') is-invalid @enderror" placeholder="Select date" type="date" value="{{ @old('begin', $entry->begin) }}">
                                        @error('begin')
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <div>
                                        ...
                                        <input name="finish" class="form-control @error('finish') is-invalid @enderror" placeholder="Select date" type="date" value="{{ @old('finish', $entry->finish) }}">
                                        @error('finish')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" name="total_entry" class="form-control @error('total_entry') is-invalid @enderror" id="validationCustom03" value="{{ @old('total_entry', $entry->total_entry) }}">
                                    @error('total_entry')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="custom-control custom-radio mb-3">
                                        <input name="status_doc" class="custom-control-input" id="status_doc1" value="1" type="radio" {{ old('status_doc', $entry->status_doc_id) == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="custom-control custom-radio mb-3">
                                        <input name="status_doc" class="custom-control-input" id="status_doc2" value="2" type="radio" {{ old('status_doc', $entry->status_doc_id) == '2' ? 'checked' : '' }}>
                                    ...
                                    <div class="custom-control custom-radio mb-3">
                                        <input name="status_doc" class="custom-control-input" id="status_doc3" value="3" type="radio" {{ old('status_doc', $entry->status_doc_id) == '3' ? 'checked' : '' }}>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="note" name="note" rows="3">{{old('note', $entry->note)}}</textarea>
                                    </div>
                                </div>
                            </div>
